declare global {
  const $pokemon: typeof import('../module/nuxt-api-party-nitro')['$pokemon']
  const $rickMorty: typeof import('../module/nuxt-api-party-nitro')['$rickMorty']
...
export { $pokemon, $rickMorty } from '#nuxt-api-party/server';
