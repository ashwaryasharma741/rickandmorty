...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, getRouterParam, readBody, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getQuery as getQuery$1, getResponseStatusText } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/devalue/index.js';
import destr from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/unctx/dist/index.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/pathe/dist/index.mjs';
import { version, unref } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/aish/workspace/vuetest/rickandmorty/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/aish/workspace/vuetest/rickandmorty/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"server","dir":"/Users/aish/workspace/vuetest/rickandmorty/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/aish/workspace/vuetest/rickandmorty","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/aish/workspace/vuetest/rickandmorty/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/aish/workspace/vuetest/rickandmorty/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/aish/workspace/vuetest/rickandmorty/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/aish/workspace/vuetest/rickandmorty/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _x0V1fE7eH1 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/Users/aish/workspace/vuetest/rickandmorty";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _rJBYjCPWUY = (nitroApp) => {
...
const _TY06tnKZsb = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _BM2ZAQ = defineEventHandler(async (event) => {
...
const _14SA3R = lazyEventHandler(() => {
...
const _lazy_d6UszL = () => Promise.resolve().then(function () { return pageview$1; });
const _lazy_8zjqPY = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/pageview', handler: _lazy_d6UszL, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_8zjqPY, lazy: true, middleware: false, method: undefined },
  { route: '/api/__api_party/:endpointId', handler: _BM2ZAQ, lazy: false, middleware: false, method: "post" },
  { route: '/_ipx/**', handler: _14SA3R, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_8zjqPY, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Technical Assessment for Frontend Developer"},{"name":"apple-mobile-web-app-status-bar-style","content":"black-translucent"},{"name":"theme-color","media":"(prefers-color-scheme: light)","content":"white"},{"name":"theme-color","media":"(prefers-color-scheme: dark)","content":"#222222"}],"link":[{"rel":"icon","href":"/favicon.ico","sizes":"any"},{"rel":"icon","type":"image/svg+xml","href":"/nuxt.svg"},{"rel":"apple-touch-icon","href":"/apple-touch-icon.png"}],"style":[],"script":[],"noscript":[],"viewport":"width=device-width,initial-scale=1"};
...
const getClientManifest = () => import('file:///Users/aish/workspace/vuetest/rickandmorty/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/aish/workspace/vuetest/rickandmorty/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
