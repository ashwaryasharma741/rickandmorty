      ...
      const { customSafelistExtractor, generateSafelist } = require("/Users/aish/workspace/vuetest/rickandmorty/node_modules/@nuxt/ui/dist/runtime/utils/colors")
      ...
      module.exports = {
        ...
        content: {
          files: [
            "/Users/aish/workspace/vuetest/rickandmorty/node_modules/@nuxt/ui/dist/runtime/components/**/*.{vue,mjs,ts}",
            "/Users/aish/workspace/vuetest/rickandmorty/node_modules/@nuxt/ui/dist/runtime/ui.config/**/*.{mjs,js,ts}"
          ],
          transform: {
            vue: (content) => {
